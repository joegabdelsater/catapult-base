...
@section('content')
    <div class="p-8">
        <div class="mb-8">
            ...
            <p>When package installation is complete, run <code class="bg-gray-700 text-white px-2 py-1">php artisan catapult:packages-setup</code> to setup all your packages:</p>
